package io.github.ygrip.testara.ui.appium.page;
...
import io.github.ygrip.testara.ui.appium.capability.AppiumByLocator;
...
public class AppiumPageFinder extends PageFinder<AppiumPage, WebElement, By> {
  ...
  @Override
  public By getLocator(AppiumPage page, String element) {
    if (page == null) {
      return null;
    }
      ...
      if (ObjectUtils.isNotEmpty(item)) {
        ...
        if (ObjectUtils.isNotEmpty(value)) {
          if (key.isTypeOrSubTypeOf(Locator.class)) {
            ...
            result = AppiumByLocator.toBy(locator);
          } else if (key.isTypeOrSubTypeOf(By.class)) {
            result = (By) value;
          } else if (key.isTypeOrSubTypeOf(AppiumBy.class)) {
            result = (AppiumBy) value;
          } else if (key.isTypeOrSubTypeOf(WebElement.class)) {
            result = toLocator((WebElement) value);
          }
        }
      } else {
        result = AppiumByLocator.toBy(resolveLocator(element));
      }
    } catch (Exception e) {
      if (!isSuppressLog()) {
        log.warn(
  ...
  @Override
  public By getLocator(AppiumPage page, String element, Map<String, ?> parameters) {
    ...
    try {
      ...
      if (ObjectUtils.isNotEmpty(item)) {
        ...
        if (ObjectUtils.isNotEmpty(value)) {
          if (key.isTypeOrSubTypeOf(Locator.class)) {
            result = AppiumByLocator.toBy((Locator) value);
          } else if (key.isTypeOrSubTypeOf(By.class)) {
            result = (By) value;
          } else if (key.isTypeOrSubTypeOf(AppiumBy.class)) {
            result = (AppiumBy) value;
  ...
  @Override
  public Supplier<WebElement> getElementFromPage(AppiumPage page, String element) throws Exception {
    if (page == null) {
      return null;
    }
      ...
      if (ObjectUtils.isNotEmpty(item)) {
        ...
        if (ObjectUtils.isNotEmpty(value)) {
          if (key.isTypeOrSubTypeOf(Locator.class)) {
            ...
            result = () -> page.driver()
              .instance()
              .findElement(AppiumByLocator.toBy(locator));
          } else if (key.isTypeOrSubTypeOf(By.class)) {
            By locator = (By) value;
            result = () -> page.driver()
              .instance()
            ...
            AppiumBy locator = (AppiumBy) value;
            result = () -> page.driver()
              .instance()
              .findElement(locator);
          } else if (key.isTypeOrSubTypeOf(WebElement.class)) {
  ...
  @Override
  public Supplier<List<WebElement>> getElementsFromPage(AppiumPage page, String element) throws Exception {
    if (page == null) {
      return null;
    }
  ...
  @Override
  public Supplier<List<WebElement>> getElementsFromPage(AppiumPage page, Locator locator) throws Exception {
    return () -> page.driver()
      .instance()
      .findElements(AppiumByLocator.toBy(locator));
  }
  ...
  @Override
  public Supplier<WebElement> getElementFromPage(AppiumPage page, Locator locator) throws Exception {
    return () -> page.driver()
      .instance()
      .findElement(AppiumByLocator.toBy(locator));
  }
    ...
    return (field, value) -> {
      ...
      if (javaType.isTypeOrSubTypeOf(Locator.class)) {
        ...
        catalog.addElement(field.getName(), (By) value)
          .ifPresent(el -> el.setAliases(generateAliases(field.getName())));
      } else if (javaType.isTypeOrSubTypeOf(AppiumBy.class)) {
        catalog.addElement(field.getName(), (AppiumBy) value)
          .ifPresent(el -> el.setAliases(generateAliases(field.getName())));
