...
/**
 * Appium implementation of {@link WaitCapability}. Uses WebDriverWait.
 */
@Log4j2
public final class AppiumWaitCapability implements WaitCapability {
  private final AppiumDriver driver;
  private Duration defaultTimeout = Duration.ofSeconds(10);

  public AppiumWaitCapability(AppiumDriver driver) {
    this.driver = driver;
  }
