...
/**
 * Regression coverage for {@link AppiumWaitCapability#untilPageLoaded(NamedPage)}: the
 ...
 */
class AppiumWaitCapabilityTest {
  ...
  void setsCurrentPageWhenPageConfirmsItIsCurrent() {
    ...
    new AppiumWaitCapability(null).untilPageLoaded(namedPage)
