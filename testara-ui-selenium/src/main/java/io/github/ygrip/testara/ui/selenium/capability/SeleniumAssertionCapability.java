...
/**
 * Selenium implementation of {@link AssertionCapability}. Fluent, fail-fast.
 */
@Log4j2
public final class SeleniumAssertionCapability extends SeleniumElementResolver implements AssertionCapability {
  private final WebDriver driver;

  public SeleniumAssertionCapability(WebDriver driver) {
    this.driver = driver;
  }
