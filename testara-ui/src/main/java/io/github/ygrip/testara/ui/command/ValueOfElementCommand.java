...
import io.github.ygrip.testara.ui.observation.TheValue;

/**
 * <p>ValueOfElementCommand class.</p>
 *
 * @author yunaz.ramadhan on 12/26/2019
 * @version $Id: $Id
 */
@CommandTag(command = "valueof", overwrite = true, cacheable = true)
public class ValueOfElementCommand implements CommandLogic<String> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public String execute(List<Object> parameters) throws Exception {
    ...
    return ActorManager.currentActor()
      .observe(TheValue.of(Optional.ofNullable(parameters.getFirst())
