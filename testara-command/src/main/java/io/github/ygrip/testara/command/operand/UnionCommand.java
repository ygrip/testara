...
/**
 * <p>UnionCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "union", overwrite = true, cacheable = true)
public class UnionCommand implements CommandLogic<List<Object>> {
  /**
   * {@inheritDoc}
   */
  @Override
