...
/**
 * <p>IntersectionCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "intersection", overwrite = true, cacheable = true)
public class IntersectionCommand implements CommandLogic<List<Object>> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public List<Object> execute(List<Object> parameters) {
    ...
    return SetUtils.intersection(params);
  }
}
