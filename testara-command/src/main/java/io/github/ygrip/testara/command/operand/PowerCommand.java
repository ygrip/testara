...
/**
 * <p>PowerCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "pow", alias = "^", overwrite = true, cacheable = true)
public class PowerCommand implements CommandLogic<Double> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public Double execute(List<Object> parameters) {
    return ObjectUtils.isEmpty(parameters) ?
        ...
        parameters.size() == 1 ?
            ...
            Math.pow(Double.parseDouble(String.valueOf(parameters.get(0))),
