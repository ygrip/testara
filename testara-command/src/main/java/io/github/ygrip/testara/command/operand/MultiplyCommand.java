...
/**
 * <p>MultiplyCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "multiply", alias = "x", overwrite = true, cacheable = true)
public class MultiplyCommand implements CommandLogic<Number> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public Number execute(List<Object> parameters) {
    ...
    if (parameters.size() == 1) {
      ...
      return NumberHelper.autoBoxingNumber(safeNull(a).multiply(safeNull(b)));
    }
  }
