...
/**
 * <p>AdditionCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "add", alias = "+", overwrite = true, cacheable = true)
public class AdditionCommand implements CommandLogic<Number> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public Number execute(List<Object> parameters) {
    ...
    if (parameters.size() == 1) {
      ...
      return NumberHelper.autoBoxingNumber(safeNull(a).add(safeNull(b)));
    }
  }
