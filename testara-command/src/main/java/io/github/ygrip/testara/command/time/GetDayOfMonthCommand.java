 ...
 * @version $Id: $Id
 */
@CommandTag(command = "day_of_month", overwrite = true)
public class GetDayOfMonthCommand implements CommandLogic<Integer> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public Integer execute(List<Object> parameters) {
    return ObjectUtils.isEmpty(parameters) ?
        ...
        DateHelper.getDayOfMonth(Long.parseLong(String.valueOf(parameters.get(0))));
  }
}
