...
/**
 * <p>ResponseCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "response", overwrite = true)
public class ResponseCommand implements CommandLogic<Object> {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  public Object execute(List<Object> parameters) throws Exception {
    ...
    try {
      return TestFramework.context().get(DataHolder.class).getResponse(path).getValue();
