...
/**
 * <p>SortAscendingCommand class.</p>
 *
 * @author yunaz.ramadhan on 10/4/2019
 * @version $Id: $Id
 */
@CommandTag(command = "ascending", alias = {"asc"}, overwrite = true, cacheable = true)
public class SortAscendingCommand implements CommandLogic<List<Object>> {
  /**
   * {@inheritDoc}
   */
  @Override
