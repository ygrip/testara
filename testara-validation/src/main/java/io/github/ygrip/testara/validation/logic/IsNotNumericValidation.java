...
/**
 * <p>IsNotNumericValidation class.</p>
 *
 * @author yunaz.ramadhan on 7/22/2024
 * @version $Id: $Id
 */
@ValidationTag(command = "IS_NOT_NUMERIC", alias = {"is not numeric"}, overwrite = true)
public class IsNotNumericValidation extends ValidatorLogic<List<String>, Boolean> {
  ...
  public boolean validate() throws Exception {
    ...
    if (CommonHelper.isBlank(getActual())) {
      ...
      setReason(String.format("%s of %s items is not numeric", matched, getActual().size()));
    }
