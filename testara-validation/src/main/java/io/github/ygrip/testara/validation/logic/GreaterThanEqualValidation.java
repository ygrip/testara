...
/**
 * <p>GreaterThanEqualValidation class.</p>
 *
 * @author yunaz.ramadhan on 12/11/2019
 * @version $Id: $Id
 */
@ValidationTag(command = "GREATER_THAN_EQUAL", alias = {"greater than equal", ">="}, overwrite = true)
public class GreaterThanEqualValidation extends ValidatorLogic<Object, Object> {

  /** {@inheritDoc} */
  @Override
  protected String setDefaultMessage() {
    return "Actual data is not greater than equal with expected data in value";
  }
